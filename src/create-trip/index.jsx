...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    if (!formData.destination || !formData.budget || !formData.travelWith || !formData.days) {
      toast("Please fill all details.");
      return;
    }

    if (formData.days > 5) {
      toast("Please enter trip days less than or equal to 10.");
      return;
    }
  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10">
      ...
      <p className="mt-3 text-gray-500 text-lg">
        Provide some basic details, and our trip planner will create a personalized itinerary just for you!
      </p>

      <div className="mt-10 flex flex-col gap-10">
  {/* Destination Selection */}
  <div>
    <h2 className="text-lg my-3 font-medium">What is your destination of choice?</h2>
    <input
      type="text"
  ...
  {/* Trip Duration */}
  <div>
    <h2 className="text-lg my-3 font-medium">How many days will your trip be?</h2>
    <Input
...
<div>
  <h2 className="text-lg my-3 font-medium">Who will be joining you on your next adventure?</h2>
  <div className="grid grid-cols-3 gap-4 mt-4">
